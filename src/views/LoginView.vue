<template>
  <div class="flex h-screen">
    <div class="w-1/2 text-white text-center" style="background-color: #54DFA3;">
      ...
      <div id="login" class="mx-40">
        ...
        <form method="POST" class="flex flex-col items-cener">
          ...
          <button class="p-2 rounded-md hover:bg-blue-300 font-bold" style="background-color: #13B07F;">Iniciar
            Sesión</button>
        </form>
      </div>
    </div>
    ...
    <div class="bg-white w-1/2">
      ...
      <p class="text-4xl text-center font-bold mx-12 mb-4" style="color: #54DFA3">Firmá todos tus documentos desde
        cualquier
        lugar con <span style="color: #13B07F;">FirmaXW</span></p>
      <p class="text-4xl text-center font-bold mx-8 mb-4" style="color: #54DFA3;">Simple. Rápido. Legal.
      </p>
