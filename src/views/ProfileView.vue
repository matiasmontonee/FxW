      ...
      <div class="m-6 mt-4">
        ...
        <div class="flex flex-col">
          <div class="flex items-center">
            <input type="text" placeholder="Nombre" v-model="datosPersonales.client_business_name" class="border-gray-300 border-b-2 w-2/5 focus:outline-none p-2 pl-0 mb-6 placeholder-gray-800 mr-4">
        ...
        <div class="flex">
          <input type="text" placeholder="Nombre" v-model="datosPersonales.client_full_name" class="border-gray-300 border-b-2 w-1/4 focus:outline-none p-2 pl-0 mb-6 placeholder-gray-800 mr-4">
          <input type="text" placeholder="Apellido" v-model="datosPersonales.client_surname" class="border-gray-300 border-b-2 w-1/4 focus:outline-none p-2 pl-0 mb-6 placeholder-gray-800">
        </div>
        <input @input="validateDNI" type="text" placeholder="DNI / CI" v-model="datosPersonales.client_dni" class="border-gray-300 border-b-2 w-1/4 focus:outline-none p-2 pl-0 mb-6 placeholder-gray-800">
        <div class="flex">
          ...
          <input type="number" placeholder="1137681841" v-model="datosPersonales.client_phone" class="border-gray-300 border-b-2 w-1/4 focus:outline-none p-2 pl-0 mb-6 placeholder-gray-800">
        </div>
        <input type="text" placeholder="Email" v-model="datosPersonales.client_mail" class="border-gray-300 border-b-2 w-1/4 focus:outline-none p-2 pl-0 mb-6 placeholder-gray-800">
...
export default {
  ...
  methods: {
    ...
    async guardarDatos() {
      ...
      const telefonoNumero = this.datosPersonales.client_phone.toString();
      ...
      if (!this.datosPersonales.client_business_name || !this.datosPersonales.client_full_name ||
        ...
        !this.datosPersonales.telefonoCodigo || !this.datosPersonales.client_phone ||
